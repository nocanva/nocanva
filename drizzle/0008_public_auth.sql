...
--> statement-breakpoint
CREATE UNIQUE INDEX `idx_workspaces_personal_owner` ON `workspaces` (`personal_owner_user_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_workspace_memberships_user` ON `workspace_memberships` (`user_id`,`created_at`);
--> statement-breakpoint
