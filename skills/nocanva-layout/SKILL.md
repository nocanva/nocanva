...
5. Shortlist 2–4 directions. Each direction must name its family, focal region, region order, alignment, media behavior, density, headline move, signature move, and copy-fit risk.
...
When showing alternatives, change at least three structural dimensions across the set: family, region order, focal region, media position, split ratio, alignment, density, or headline geometry. Changing only hue or font is a duplicate.
